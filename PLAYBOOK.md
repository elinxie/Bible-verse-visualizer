...
| — | NEXT SESSION | Remaining 2 Samuel gaps: chs. 4, 8-10, 13-14, 16-17, 19-23 (Ish-bosheth's assassination, David's wars of conquest, Tamar/Amnon, Absalom's exile and return, Shimei/Ziba, the revolt's aftermath, David's last words and mighty men) — pick 2 at a time. Otherwise continue the "Then" roadmap with Genesis 6-9 (the Flood); re-scan GitHub issues first (only issue #7 exists as of 2026-07-15, already closed/shipped — check for anything new) | ≤1 sonnet | pending |
...
**2 Samuel:** [x] 1(M) · [x] 2(M) · [x] 3(M) · [x] 5(M) · [x] 6(M) · [x] 7(M) · [x] 11–12(M) · [x] 15(M) · [x] 18(M) · [x] 24(M) — key-chapter list COMPLETE; full-book gaps remaining: 4, 8–10, 13–14, 16–17, 19–23
...
**Datasets:** places 123/200 (+1 new: eden) · people 97/120 (unchanged this iteration — reused adam, eve) · objects 57/60 (+7 new: tree-of-life, tree-of-knowledge, serpent, fig-leaves, skins-garment, eden-rivers, cherub-flaming-sword)
