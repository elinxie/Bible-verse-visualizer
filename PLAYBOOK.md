...
| — | NEXT SESSION | Curate 2 Sam 24 (M) to finish the 2 Samuel key-chapter list, then move on to Genesis 1–3; re-scan GitHub issues first | ≤1 sonnet | pending |
...
**Datasets:** places 122/200 (+2 new: ephraim-forest, geshur) · people 95/120 (+8 new: absalom, ahithophel, hushai, ittai, zadok, abiathar, ahimaaz, cushite-messenger) · objects 50/60 (+2 new: mule, absalom-pillar)
...
| # | Issue | Scope | Slot |
|---|-------|-------|------|
| [#7](https://github.com/elinxie/Bible-verse-visualizer/issues/7) | Add translations to city names | ✅ **Shipped in iteration 7** (see Ledger); 3 more places (engedi/ziph/maon) topped up with `meaning` in iteration 8. Remaining ~65 non-curated places (jerusalem-adjacent minor sites, all Isa/Jer/Ezek/Rev-era towns, etc.) still lack `meaning` — a pure data top-up, safe to ride along with a future curation batch rather than needing its own iteration. | Repo re-scanned 2026-07-13: still the only issue ever filed (open+closed), already closed — no open issues exist. |
