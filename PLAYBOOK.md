...
| — | NEXT SESSION | Continue 2 Samuel key chapters (15, 18, 24 — M depth); re-scan GitHub issues first | ≤1 sonnet | pending |
...
**2 Samuel:** [x] 1(M) · [x] 5(M) · [x] 6(M) · [x] 7(M) · [x] 11–12(M) · [ ] 15 · [ ] 18 · [ ] 24
...
**Datasets:** places 120/200 (reused kiriath-jearim/jerusalem/rabbah, no new this batch) · people 87/120 (+3 new: bathsheba, uriah, joab) · objects 47/60 (+1 new: ewe-lamb)
