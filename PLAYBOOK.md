...
**2 Samuel:** [x] 1(M) · [x] 2(M) · [x] 3(M) · [x] 4(M) · [x] 5(M) · [x] 6(M) · [x] 7(M) · [x] 8(M) · [x] 9(M) · [x] 10(M) · [x] 11–12(M) · [x] 13–14(M) · [x] 15(M) · [x] 16–17(M) · [x] 18(M) · [x] 19(M) · [x] 20(M) · [x] 21(M) · [x] 24(M) — key-chapter list COMPLETE; full-book gaps remaining: 22–23
...
**Datasets:** places 141/200 (+3 from iteration 22: gob, zela, abel-beth-maacah) · people 193/120 (target exceeded — target was a floor, not a cap; +7 from iteration 22: amasa, sheba-bichri, wise-woman-abel, rizpah, gibeonites, philistine-giants, elhanan) · objects 82/60 (target exceeded)
