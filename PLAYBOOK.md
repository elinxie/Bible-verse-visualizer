...
| — | NEXT SESSION | Remaining 2 Samuel gaps: chs. 9-10, 13-14, 16-17, 19-23 (Mephibosheth restored, the Ammonite war/Rabbah siege recap, Tamar/Amnon, Absalom's exile and return, Shimei/Ziba, the revolt's aftermath, David's last words and mighty men) — pick 2 at a time. Otherwise continue the "Then" roadmap with Genesis 6-9 (the Flood); re-scan GitHub issues first (only issue #7 exists as of 2026-07-16, already closed/shipped — check for anything new) | ≤1 sonnet | pending |
...
**2 Samuel:** [x] 1(M) · [x] 2(M) · [x] 3(M) · [x] 4(M) · [x] 5(M) · [x] 6(M) · [x] 7(M) · [x] 8(M) · [x] 11–12(M) · [x] 15(M) · [x] 18(M) · [x] 24(M) — key-chapter list COMPLETE; full-book gaps remaining: 9–10, 13–14, 16–17, 19–23
...
**Datasets:** places 125/200 (+2 new: beeroth, zobah) · people 108/120 (+8 new: rechab, baanah, mephibosheth, hadadezer, jehoshaphat-recorder, seraiah-scribe, benaiah, cherethites-pelethites) · objects 58/60 (+1 new: measuring-cord)
