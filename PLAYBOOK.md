...
| 20 | 2026-07-20 | Re-scanned all GitHub issues (open+closed): still only issue #7, closed, already shipped in iteration 7 — nothing new to slot into the Feature backlog. Curated 2 Sam 13 (Amnon's rape of Tamar, Absalom's silent hatred, the sheepshearing feast at Baal-hazor where Amnon is killed, Absalom's flight to Geshur, M) + 2 Sam 14 (Joab's wise-woman-of-Tekoa scheme to secure Absalom's recall, Absalom barred from David's presence for two more years, his famous looks/hair, the burned-field ultimatum, the final reconciliation kiss, M) — continues the "2 Samuel full-book gaps" item; new place `baal-hazor`; `meaning` top-up on `tekoa`; new people `amnon`, `tamar-daughter-david` (distinguished from Judah's daughter-in-law Tamar to avoid an id collision), `jonadab`, `wise-woman-tekoa`; new objects `tamar-royal-robe`, `absalom-hair`; reused existing `geshur`/`jerusalem`/`absalom`/`joab`/`david`; fixtures 10-13/10-14; sweep entries added — smoke suite green, no regressions | 1× sonnet ENG (curation) | ✅ shipped |
| — | NEXT SESSION | Remaining 2 Samuel gaps: chs. 16-17, 19-23 (Shimei's cursing and Ziba's second appearance during the revolt, Ahithophel vs. Hushai's counsel, the revolt's aftermath, David's last words and mighty men) — pick 2-3 at a time. Genesis's own key-chapter roadmap slots (6–9, 12, 22, 28, 37, 41, 45) are now subsumed by the full-book pass in iteration 19 — mark them done below. Continue the "Then" roadmap with Exodus 3, 12, 19–20, 32 next (Exod 14 already done). Re-scan GitHub issues first (only issue #7 exists as of 2026-07-20, already closed/shipped — check for anything new) | ≤1 sonnet | pending |
...
**Datasets:** places 137/200 (+1 from iteration 20: baal-hazor) · people 183/120 (target exceeded — target was a floor, not a cap; +4 from iteration 20: amnon, tamar-daughter-david, jonadab, wise-woman-tekoa) · objects 84/60 (target exceeded — +2 from iteration 20: tamar-royal-robe, absalom-hair)
