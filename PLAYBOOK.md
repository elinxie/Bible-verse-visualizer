...
**2 Samuel:** [x] 1(M) · [x] 2(M) · [x] 3(M) · [x] 4(M) · [x] 5(M) · [x] 6(M) · [x] 7(M) · [x] 8(M) · [x] 9(M) · [x] 10(M) · [x] 11–12(M) · [x] 13–14(M) · [x] 15(M) · [x] 18(M) · [x] 24(M) — key-chapter list COMPLETE; full-book gaps remaining: 16–17, 19–23
...
**Datasets:** places 137/200 (+1 from iteration 20: baal-hazor) · people 184/120 (target exceeded — target was a floor, not a cap; +5 from iteration 20: tamar-david, amnon, jonadab, wise-woman-tekoa, talmai) · objects 82/60 (target exceeded)
