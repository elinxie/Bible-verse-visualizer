...
| 20 | 2026-07-19 | Re-scanned all GitHub issues (open+closed, ordered oldest→newest): still only issue #7, closed, already shipped in iteration 7 — nothing new to slot into the Feature backlog. Curated 2 Sam 13 (Amnon's rape of Tamar via Jonadab's scheme, Absalom's revenge killing of Amnon at the Baal-hazor sheep-shearing feast, flight to Geshur, M) + 2 Sam 14 (Joab's wise-woman-of-Tekoa parable securing David's leave for Absalom's return, two years barred from the king's presence, reconciliation, M) — continues the "2 Samuel full-book gaps" item (remaining: 16-17, 19-23). New place `baal-hazor` (meaning, ancient note, scene recipe); reused existing `tekoa`/`geshur`; new people `amnon`, `tamar-david` (disambiguated from the existing `tamar-judah`, Genesis 38, same collision-avoidance pattern as `gad`/`gad-son-jacob`), `jonadab`, `talmai`, `wise-woman-tekoa`; reused `absalom`/`david`/`joab`; fixtures 10-13/10-14; sweep entries added — smoke suite green (playwright + /opt/pw-browsers chromium), no regressions | 1× sonnet ENG (curation) | ✅ shipped |
| — | NEXT SESSION | Remaining 2 Samuel gaps: chs. 16-17, 19-23 (Shimei's cursing and Ziba's provisioning during David's flight, Ahithophel's counsel and suicide, the revolt's collapse, Shimei/Ziba's second appearance and Sheba's revolt, David's last words and the mighty men's exploits) — pick 2-3 at a time. Genesis's own key-chapter roadmap slots (6–9, 12, 22, 28, 37, 41, 45) are subsumed by the full-book pass in iteration 19 — already marked done below. Continue the "Then" roadmap with Exodus 3, 12, 19–20, 32 next (Exod 14 already done). Re-scan GitHub issues first (only issue #7 exists as of 2026-07-19, already closed/shipped — check for anything new) | ≤1 sonnet | pending |
...
**Datasets:** places 137/200 (+1 from iteration 20: baal-hazor) · people 184/120 (target exceeded — target was a floor, not a cap; +5 from iteration 20: amnon, tamar-david, jonadab, talmai, wise-woman-tekoa) · objects 82/60 (target exceeded)
